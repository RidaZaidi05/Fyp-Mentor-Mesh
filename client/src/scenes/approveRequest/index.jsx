...
const RequestApproval = () => {
    ...
    const handleDownload = (transcript) => {
        const url = `http://localhost:3001/transcripts/${transcript}`;
    ...
    try {
        ...
        const response = await axios.post('http://localhost:3001/acceptRequest', requestData);
    ...
    const handleReject = async (notificationId) => {
        ...
        if (notificationId) {
            try {
                ...
                await axios.delete(`http://localhost:3001/deleteReqNotifications/${notificationId}`);
                fetchUnreadNotifications(user, navigate);
            } catch (error) {
                    ...
                    <Grid item xs={12} md={6} container justifyContent="flex-end" sx={{ marginTop: '30px' }}> {/* Add margin to the top */}
                        ...
                        <Grid item xs={12}>
                            ...
                            >
                                ...
                                <Typography variant="body1" gutterBottom sx={{ paddingLeft: '16px' }}> {/* Adjust left padding */}
                                    <b>Transcript: </b>
                                    <Button component="a" href={`http://localhost:3001/transcripts/${member1Data.transcript}`} size="small" target="_blank" rel="noopener noreferrer" variant="contained" style={{ marginRight: '8px' }}> {/* Add margin-right */}
                                        View
                                    </Button>
                        ...
                        <Grid item xs={12}>
                            ...
                            >
                                ...
                                <Typography variant="body1" gutterBottom sx={{ paddingLeft: '16px' }}>
                                    <b>Transcript: </b>
                                    <Button component="a" href={`http://localhost:3001/transcripts/${member2Data.transcript}`} size="small" target="_blank" rel="noopener noreferrer" variant="contained" style={{ marginRight: '8px' }}> {/* Add margin-right */}
                                        View
                                    </Button>
                        ...
                        <Grid item xs={12}>
                            ...
                            >
                                ...
                                <Typography variant="body1" gutterBottom sx={{ paddingLeft: '16px' }}> {/* Adjust left padding */}
                                    <b>Transcript:</b> <Button component="a" href={`http://localhost:3001/transcripts/${member3Data.transcript}`} size="small" target="_blank" rel="noopener noreferrer" variant="contained" style={{ marginRight: '8px' }}> {/* Add margin-right */}
                                        View
                                    </Button>
